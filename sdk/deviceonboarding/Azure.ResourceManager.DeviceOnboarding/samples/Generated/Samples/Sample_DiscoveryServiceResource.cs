...
namespace Azure.ResourceManager.DeviceOnboarding.Samples
{
    public partial class Sample_DiscoveryServiceResource
    {
        ...
        {
            // Generated from example definition: specification/deviceonboarding/resource-manager/Microsoft.DeviceOnboarding/preview/2024-12-01-preview/examples/DiscoveryServices_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "DiscoveryServices_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/deviceonboarding/resource-manager/Microsoft.DeviceOnboarding/preview/2024-12-01-preview/examples/DiscoveryServices_Delete_MaximumSet_Gen.json
            // this example is just showing the usage of "DiscoveryServices_Delete" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/deviceonboarding/resource-manager/Microsoft.DeviceOnboarding/preview/2024-12-01-preview/examples/DiscoveryServices_Update_MaximumSet_Gen.json
            // this example is just showing the usage of "DiscoveryServices_Update" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            DiscoveryServicePatch patch = new DiscoveryServicePatch
            {
...
["key6682"] = "vsuqfaifoynihslbsoals"
            ...
            ArmOperation<DiscoveryServiceResource> lro = await discoveryService.UpdateAsync(WaitUntil.Completed, patch);
