...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public partial class PatchFdoBootstrapAuthenticationRule : PatchBootstrapAuthenticationRule
    {
        ...
        {
            BootstrapAuthenticationType = BootstrapAuthenticationType.FDO;
        }
        ...
        internal PatchFdoBootstrapAuthenticationRule(BootstrapAuthenticationType bootstrapAuthenticationType, FdoPublicKeys publicKeys, OwnershipVoucherStorage ownershipVoucherStorage, Uri rendezvousEndpoint) : base(bootstrapAuthenticationType)
        {
