...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public partial class PatchEvenlyDistributedAllocationRule : AllocationRulePatch
    {
        ...
        internal PatchEvenlyDistributedAllocationRule(string name, EndpointType? endpointType, AllocationType allocationType, IList<PatchAllocationEndpoint> endpoints) : base(name, endpointType, allocationType)
        {
            Endpoints = endpoints;
