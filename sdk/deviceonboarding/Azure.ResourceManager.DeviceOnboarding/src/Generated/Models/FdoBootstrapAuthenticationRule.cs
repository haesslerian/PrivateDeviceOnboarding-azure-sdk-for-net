...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public partial class FdoBootstrapAuthenticationRule : BootstrapAuthenticationRule
    {
        ...
        {
            AuthenticationType = BootstrapAuthenticationType.FDO;
        }
        ...
        internal FdoBootstrapAuthenticationRule(BootstrapAuthenticationType authenticationType, FdoPublicKeys publicKeys, OwnershipVoucherStorage ownershipVoucherStorage, Uri rendezvousEndpoint) : base(authenticationType)
        {
