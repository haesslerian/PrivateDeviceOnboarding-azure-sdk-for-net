...
{
    public partial class X5ChainPublicKeyDetails : IUtf8JsonSerializable
    {
        ...
        internal static X5ChainPublicKeyDetails DeserializeX5ChainPublicKeyDetails(JsonElement element)
        {
            ...
            return new X5ChainPublicKeyDetails(publicKeyType, x5Chain);
        }
    }
}
