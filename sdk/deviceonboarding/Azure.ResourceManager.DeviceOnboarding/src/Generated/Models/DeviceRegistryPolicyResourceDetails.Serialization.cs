...
{
    public partial class DeviceRegistryPolicyResourceDetails : IUtf8JsonSerializable
    {
        ...
        internal static DeviceRegistryPolicyResourceDetails DeserializeDeviceRegistryPolicyResourceDetails(JsonElement element)
        {
            ...
            return new DeviceRegistryPolicyResourceDetails(type, operationalIdentityInfo, resourceMetadata);
        }
    }
}
